...
fun airline#extensions#coli#ColorTabline()
  ...
  hi TabLine           ctermfg=16   ctermbg=27  cterm=None
  hi TabLineMod        ctermfg=16   ctermbg=98  cterm=None
  hi TabLineSession    ctermfg=39   ctermbg=20  cterm=None

  hi TabLineSel        ctermfg=254  ctermbg=26  cterm=Bold
  hi TabLineSelBuf     ctermfg=254  ctermbg=27  cterm=Bold
  hi TabLineSelMod     ctermfg=255  ctermbg=98  cterm=Bold
  ...
  hi TabLineModSep     ctermfg=98   ctermbg=17  cterm=None
  hi TabLineSelModSep  ctermfg=98   ctermbg=17  cterm=None
