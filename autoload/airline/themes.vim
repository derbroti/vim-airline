...
if !exists(":def") || !airline#util#has_vim9_script()
  ...
  function! airline#themes#generate_color_map(sect1, sect2, sect3, ...)
    ...
    if a:0 > 0
      call extend(palette, {
            \ 'airline_w': [ a:1[0] , a:1[1] , a:1[2] , a:1[3] , get(a:1 , 4 , '' ) ] ,
            \ 'airline_x': [ a:2[0] , a:2[1] , a:2[2] , a:2[3] , get(a:2 , 4 , '' ) ] ,
            \ 'airline_y': [ a:3[0] , a:3[1] , a:3[2] , a:3[3] , get(a:3 , 4 , '' ) ] ,
            \ 'airline_z': [ a:4[0] , a:4[1] , a:4[2] , a:4[3] , get(a:4 , 4 , '' ) ] ,
            \ })
    else
      call extend(palette, {
            \ 'airline_w': [ a:sect3[0] , a:sect3[1] , a:sect3[2] , a:sect3[3] , '' ] ,
  ...
  def airline#themes#generate_color_map(sect1: list<any>, sect2: list<any>, sect3: list<any>, ...rest: list<any>): dict<any>
    ...
    if rest->len() > 0
      extend(palette, {
        'airline_w': [ rest[0][0], rest[0][1], rest[0][2], rest[0][3], get(rest[0], 4, '' ) ],
        'airline_x': [ rest[1][0], rest[1][1], rest[1][2], rest[1][3], get(rest[1], 4, '' ) ],
        'airline_y': [ rest[2][0], rest[2][1], rest[2][2], rest[2][3], get(rest[2], 4, '' ) ],
        'airline_z': [ rest[3][0], rest[3][1], rest[3][2], rest[3][3], get(rest[3], 4, '' ) ],
        })
    else
      extend(palette, {
        'airline_w': [ sect3[0], sect3[1], sect3[2], sect3[3], '' ],
